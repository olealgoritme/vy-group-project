...
public class VYNotification {
    ...
    public static void displayOffBoardingNotification(Context ctx) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(ctx)
                ...
                .setContentTitle("Vy")
                .setContentText(ctx.getResources().getString(R.string.text_notify_offboarding))
                .setChannelId("vy")
                .setOngoing(true)
                .setAutoCancel(true)
                .setPriority(NotificationCompat.PRIORITY_MAX);

        builder.addAction(android.R.drawable.ic_menu_close_clear_cancel, "OK", pIntentCorrect);
